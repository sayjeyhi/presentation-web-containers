      ...
      var e = { 4567: function(e2, t2, i2) {
        ...
        let d = t2.AccessibilityManager = class extends a.Disposable {
          ...
          _handleSelectionChange() {
            ...
            if (i3.node.compareDocumentPosition(s3) & (Node.DOCUMENT_POSITION_CONTAINED_BY | Node.DOCUMENT_POSITION_PRECEDING) && (i3 = { node: s3, offset: ((_a = s3.textContent) == null ? void 0 : _a.length) ?? 0 }), !this._rowContainer.contains(i3.node))
              return;
